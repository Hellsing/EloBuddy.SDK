...
namespace EloBuddy.SDK
{
    public static class Core
    {
        ...
        /// <param name="delayTime">The delay time when the Action should be invoked in milliseconds</param>
        ...
        /// <summary>
        /// Repeats an Action with a delay time. This method is thread-safe.
        /// </summary>
        /// <param name="action">The Action to delay</param>
        /// <param name="delayTime">The delay time when the Action should be invoked in milliseconds</param>
        /// <param name="repeatEndTime">The time when the Action should be repeated in milliseconds</param>
