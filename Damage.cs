...
namespace EloBuddy.SDK
{
    ...
    public static class Damage
    {
        ...
        internal static PrecalculatedAutoAttackDamage GetStaticAutoAttackDamage(this AIHeroClient fromHero, bool targetIsMinion)
        {
            ...
            {
                precalculated._rawPhysical += fromHero.BaseAttackDamage;
            }
            ...
            {
                precalculated._rawMagical += 0.75f * fromHero.BaseAttackDamage + 0.5f * fromHero.FlatMagicDamageMod;
            }
            ...
            {
                precalculated._rawPhysical += 2f * fromHero.BaseAttackDamage;
            }
            ...
            if (fromHero.GetBuffCount("itemstatikshankcharge") == 100)
            {
                ...
                //Kircheis Shard: ENERGIZED STRIKE: Your next basic attack deals +40 bonus on-hit magic damage.
            ...
            switch (fromHero.Hero)
            {
                ...
                case Champion.Alistar:
                    ...
                    {
                        precalculated._rawMagical += 40f + 10 * fromHero.Level;
                    }
                    break;
                case Champion.Ashe:
                    if (fromHero.HasBuff("asheqbuff"))
                    {
                        precalculated._rawPhysical += (100f + 5f * fromHero.Spellbook.GetSpell(SpellSlot.Q).Level) / 100f *
                ...
                case Champion.Darius:
                    ...
                    {
                        precalculated._rawPhysical += 0.4f * fromHero.TotalAttackDamage;
                    }
                    break;
                case Champion.Diana:
                ...
                case Champion.Rengar:
                    ...
                    {
                        precalculated._rawPhysical += 104f + fromHeroLevel * 16f + 2.4f * fromHero.FlatPhysicalDamageMod;
                    }
                    else if (fromHero.HasBuff("rengarqbase"))
                    {
                        precalculated._rawPhysical += 20f + 20f * fromHero.Spellbook.GetSpell(SpellSlot.Q).Level + 0.2f +
                                                      0.1f * fromHero.Spellbook.GetSpell(SpellSlot.Q).Level *
                                                      fromHero.TotalAttackDamage;
                    }
                    break;
                case Champion.Riven:
                ...
                case Champion.Shaco:
                    ...
                    {
                        precalculated._rawPhysical += 5f + 15f * fromHero.Spellbook.GetSpell(SpellSlot.Q).Level + 0.5f * fromHero.FlatMagicDamageMod;
                    }
                    break;
                case Champion.Shen:
                    //TODO
        ...
        internal static float GetAutoAttackDamage(this AIHeroClient fromHero, Obj_AI_Base target, PrecalculatedAutoAttackDamage precalculated)
        {
            ...
            switch (fromHero.Hero)
            {
                case Champion.Akali:
                    ...
                    {
                        rawMagicalDamage += 20f + 25f * fromHero.Spellbook.GetSpell(SpellSlot.Q).Level + 0.5f * fromHero.FlatMagicDamageMod;
                    }
                    break;
                case Champion.Ashe:
                    /*
                ...
                case Champion.Ekko:
                    ...
                    {
                        rawMagicalDamage += 30f + (fromHero.Level - 1) * 110f / 17f + 0.8f * fromHero.FlatMagicDamageMod;
                    }
                    break;
                case Champion.Gnar:
                ...
                case Champion.Katarina:
                    ...
                    {
                        rawMagicalDamage += fromHero.Level / 1.75f + 3f * fromHero.Level + 71.5f + fromHero.FlatPhysicalDamageMod +
                                            (0.55f + 0.15f * (int) ((fromHero.Level - 1) / 5)) * fromHero.FlatMagicDamageMod;
                    }
                    break;
            ...
            bool isAutoAttackOrTargetted = false)
        {
            ...
            if (fromHero != null)
            {
                ...
                // Bounty Hunter
                // You gain a permanent 1.5 % damage increase for each unique enemy champion you kill
                //percentMod *= (1.0f + 0.015f * Buff.Count);
