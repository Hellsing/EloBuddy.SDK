...
namespace EloBuddy.SDK.Spells
{
    ...
    public static class SummonerSpells
    {
        ...
        public static Spell.Skillshot PoroToss = new Spell.Skillshot(SpellSlot.Unknown, 1600, SkillShotType.Linear, 0, 1000, 60);
        ...
        public static Spell.Active ToTheKing = new Spell.Active(SpellSlot.Unknown, int.MaxValue);
